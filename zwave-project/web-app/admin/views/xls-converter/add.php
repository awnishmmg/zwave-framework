...
<form action="<?php echo base_url('admin/tools/xls-upload') ;?>" method="post" 
...
<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div class="form-group">
					...
					<select class="form-control" name="conversion_type" 
					   id="conversion_type" class="form-control" 
					   onchange="getConversions();">

						<option value="">--Select--</option>
						<option value="xls_to_csv">Excel to Csv</option>
						<option value="zip_to_csv">Zip to Csv</option>
						<!-- <option value="csv_to_xls">Csv to Excel</option> -->

					</select>
					<span style="color:red;">
						<?php echo set_error('comp_username',$error); ?>
					</span>
				</div>
		  	</div>
		...
		<hr class="hr"/>
		<div class="row" id="append_upload">
...
<!-- Dummy Fields -->
<div class="row" id="excel_multiple" style="display: none;">
			<div class="col-md-3">
				<b>Upload Multiple excels *</b> 
			</div>
			<div class="col-md-5">
				<div class="form-group">

					<input type="file" name="uploaded_files[]" class="form-control" accept=".xlsx,.xls" multiple required/>
					<span style="color:red;"><?php  
					echo set_error('comp_username',$error); ?></span>
				<a href="javascript:void()">Select Multiple excel file using ctrl</a>
				</div>
		  	</div>
		</div>

		<div class="row" id="zip_multiple" style="display: none;">
			<div class="col-md-3">
				<b>Upload Excel Zip *</b> 
			</div>
			<div class="col-md-5">
				<div class="form-group">

					<input type="file" name="uploaded_files" class="form-control" accept=".zip" required/>
					<span style="color:red;"><?php echo set_error('comp_username',$error); ?></span>
					<a href="javascript:void()">Select Zip File Containing one or more Excels</a>
				</div>
		  	</div>
		</div>

		<div class="row" id="csv_multiple" style="display: none;">
			<div class="col-md-3">
				<b>Upload CSV Zip *</b> 
			</div>
			<div class="col-md-5">
				<div class="form-group">
					...
					<input type="file" name="uploaded_files[]" class="form-control" accept=".zip" required />
					<span style="color:red;"><?php echo set_error('comp_username',$error); ?></span>
					<a href="javascript:void()">Select Zip File Containing one or more Csv</a>
				</div>
		  	</div>
		</div>
<!-- Dummy Fields -->
