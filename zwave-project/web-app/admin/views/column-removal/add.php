...
<form action="<?php echo base_url('admin/tools/column-removal-upload') ;?>" method="post" 
...
<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<b>Remove Column From *</b> 
			</div>
			<div class="col-md-5">
				<div class="form-group">

					<select name="column_from" required class="form-control">
						<option value="">Select</option>
						<?php foreach (range('A', 'Z') as $index => $value) : ?> 
						<option value="<?php echo $index+1 ?>"><?php echo $value; ?></option>
						<?php endforeach; ?>
					</select>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<b>Remove Column To *</b> 
			</div>
			<div class="col-md-5">
				<div class="form-group">

					<select name="column_to" required class="form-control">
						<option value="">Select</option>
						<?php foreach (range('A', 'Z') as $index => $value) : ?> 
						<option value="<?php echo $index+1 ?>"><?php echo $value; ?></option>
						<?php endforeach; ?>
