...
$hooks_data = $hooks->getAllHooksDataByUserID($user_id);
load::model('user/User_sms_api');
$sms_api = new User_sms_api_model();
$sms_data=current($sms_api->getApiProcNumberByUserId($user_id));
$sender_id=$sms_data['sender_id'];
$message=$sms_data['message'];
$acc_username=$sms_data['acc_username'];
$acc_password=$sms_data['acc_password'];
...
<div class="card">
	<div class="card-header mt-0" style="background-color: white;border-top: 3px solid black;">
		<div class="row">
			...
			<div class="col-md-2">
			<a href="<?php echo base_url('user/miscall-logs'); ?>"><button class="btn btn-dark">Refresh</button></a>
			</div>
		</div>
	</div>
...
<tr>
    ...
    <tr id="collapse_data<?php echo $i?>" style="display:none;background-color:yellow;">
	          ...
	          <td colspan="3">https://apibulksms.com/pushsms</td>
	   

	        <td><?php  echo $sender_id; ?></td>
	        <td><?php  echo $acc_password; ?></td>   
